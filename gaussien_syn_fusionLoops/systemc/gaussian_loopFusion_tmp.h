...
#ifndef _gaussian_loopFusion_tmp_H_
#define _gaussian_loopFusion_tmp_H_
...
struct gaussian_loopFusion_tmp_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(gaussian_loopFusion_tmp_core);
    gaussian_loopFusion_tmp_core(sc_core::sc_module_name) {
        ...
        for (unsigned i = 0; i < 2073600; i = i + 1) {
            mem[i] = 0;
        }
    }
...
SC_MODULE( gaussian_loopFusion_tmp )
{
    static const unsigned int DataWidth = 32;
    static const unsigned int AddressRange = 2073600;
    static const unsigned int AddressWidth = 21;
    ...
    SC_CTOR( gaussian_loopFusion_tmp ) {
        meminst = new gaussian_loopFusion_tmp_core <2, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    gaussian_loopFusion_tmp_core <2, 1, DataWidth, AddressWidth, AddressRange>* meminst;
...
#endif //_gaussian_loopFusion_tmp_H_
