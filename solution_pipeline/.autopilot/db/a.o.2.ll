...
@.str7 = private constant [36 x i8] c"gaussian_scalarized_label0_pipeline\00", align 8 ; <[36 x i8]*> [#uses=3]
...
bb1:                                              ; preds = %bb2
  call void (...)* @_ssdm_op_SpecLoopName([36 x i8]* @.str7) nounwind, !dbg !44
  %tmp.24 = call i32 (...)* @_ssdm_op_SpecRegionBegin([36 x i8]* @.str7) nounwind, !dbg !44 ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @.str18) nounwind, !dbg !45
  ...
  %tmp.27 = zext i16 %in.load.6 to i64, !dbg !45  ; <i64> [#uses=1]
  %tmp.25 = sitofp i64 %tmp.27 to float, !dbg !45 ; <float> [#uses=1]
  ...
  %tmp.31 = zext i16 %in.load.7 to i64, !dbg !45  ; <i64> [#uses=1]
  %tmp.28 = sitofp i64 %tmp.31 to float, !dbg !45 ; <float> [#uses=1]
  ...
  %tmp.41 = zext i16 %in.load.8 to i64, !dbg !45  ; <i64> [#uses=1]
  %tmp.32 = sitofp i64 %tmp.41 to float, !dbg !45 ; <float> [#uses=1]
  ...
  %tmp.42 = trunc i64 %tmp.39 to i16, !dbg !47    ; <i16> [#uses=1]
  ...
  store i16 %tmp.42, i16* %out.addr, align 2, !dbg !47
  ...
  %0 = call i32 (...)* @_ssdm_op_SpecRegionEnd([36 x i8]* @.str7, i32 %tmp.24) nounwind, !dbg !50 ; <i32> [#uses=0]
  br label %bb2, !dbg !44

bb2:                                              ; preds = %bb1, %bb
  %indvar = phi i11 [ 0, %bb ], [ %tmp6, %bb1 ]   ; <i11> [#uses=3]
  %tmp0.2 = phi float [ %tmp1, %bb ], [ %tmp2, %bb1 ] ; <float> [#uses=2]
  %tmp0.1 = phi float [ %tmp0, %bb ], [ %tmp0.2, %bb1 ] ; <float> [#uses=1]
  ...
  call void @llvm.dbg.value(metadata !{i11 %j}, i64 0, metadata !51), !dbg !44
  %1 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 1918, i64 1918, i64 1918) nounwind ; <i32> [#uses=0]
...
bb4:                                              ; preds = %bb2, %entry
  ...
  call void @llvm.dbg.value(metadata !{i11 %i}, i64 0, metadata !53), !dbg !36
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 1079, i64 1079, i64 1079) nounwind ; <i32> [#uses=0]
...
!50 = metadata !{i32 29, i32 0, metadata !37, null}
!51 = metadata !{i32 459008, metadata !37, metadata !"j", metadata !28, i32 20, metadata !52} ; [ DW_TAG_auto_variable ]
!52 = metadata !{i32 458788, metadata !27, metadata !"int", metadata !27, i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!53 = metadata !{i32 459008, metadata !37, metadata !"i", metadata !28, i32 20, metadata !52} ; [ DW_TAG_auto_variable ]
