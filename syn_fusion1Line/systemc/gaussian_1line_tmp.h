...
#ifndef _gaussian_1line_tmp_H_
#define _gaussian_1line_tmp_H_
...
struct gaussian_1line_tmp_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(gaussian_1line_tmp_core);
    gaussian_1line_tmp_core(sc_core::sc_module_name) {
...
SC_MODULE( gaussian_1line_tmp )
{
    ...
    SC_CTOR( gaussian_1line_tmp ) {
        meminst = new gaussian_1line_tmp_core <2, 2, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    gaussian_1line_tmp_core <2, 2, DataWidth, AddressWidth, AddressRange>* meminst;
