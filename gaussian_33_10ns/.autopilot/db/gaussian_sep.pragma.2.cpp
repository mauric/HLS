# 1 "/users/deastir/mcaceres/Documents/VIVADO/TP_Vivado_HLS/TP_Vivado_HLS/gaussian/solution1/.autopilot/db/gaussian_sep.pragma.1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 2 "src/gaussian_sep.cpp" 2

static float k[3] = {0.24664, 0.60671, 0.24664};

/* Store result of first convolution in this array */
static float tmp[1080][1920];

void gaussian_sep(unsigned short in[1080][1920], unsigned short out[1080][1920]) {_ssdm_SpecArrayDimSize(in,1080);_ssdm_SpecArrayDimSize(out,1080);
    //TODO
}
