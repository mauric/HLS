...
define internal fastcc void @gaussian_3x3([1920 x i16]* %in, [1920 x i16]* %out) nounwind {
entry:
  call void @llvm.dbg.value(metadata !{[1920 x i16]* %in}, i64 0, metadata !845)
  call void @llvm.dbg.value(metadata !{[1920 x i16]* %out}, i64 0, metadata !854)
  call void (...)* @_ssdm_SpecArrayDimSize([1920 x i16]* %in, i32 1080) nounwind, !dbg !855
  call void (...)* @_ssdm_SpecArrayDimSize([1920 x i16]* %out, i32 1080) nounwind, !dbg !855
  br label %bb4, !dbg !858

bb1:                                              ; preds = %bb2
  call void (...)* @_ssdm_SpecKeepArrayLoad(float 0x3FAF253DA0000000) nounwind
  %tmp.4 = sext i32 %indvar to i64, !dbg !859     ; <i64> [#uses=3]
  %in.addr = getelementptr inbounds [1920 x i16]* %in, i64 %tmp.2, i64 %tmp.4, !dbg !859 ; <i16*> [#uses=1]
  %in.load = load i16* %in.addr, align 2, !dbg !859 ; <i16> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %in.load) nounwind
  %tmp.5 = zext i16 %in.load to i32, !dbg !859    ; <i32> [#uses=1]
  %tmp.6 = sitofp i32 %tmp.5 to float, !dbg !859  ; <float> [#uses=1]
  %tmp.7 = fmul float %tmp.6, 0x3FAF253DA0000000, !dbg !859 ; <float> [#uses=1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float 0x3FC3275EE0000000) nounwind
  %tmp.8 = sext i32 %j to i64, !dbg !859          ; <i64> [#uses=4]
  %in.addr.1 = getelementptr inbounds [1920 x i16]* %in, i64 %tmp.2, i64 %tmp.8, !dbg !859 ; <i16*> [#uses=1]
  %in.load.1 = load i16* %in.addr.1, align 2, !dbg !859 ; <i16> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %in.load.1) nounwind
  %tmp.9 = zext i16 %in.load.1 to i32, !dbg !859  ; <i32> [#uses=1]
  %tmp.10 = sitofp i32 %tmp.9 to float, !dbg !859 ; <float> [#uses=1]
  %tmp.11 = fmul float %tmp.10, 0x3FC3275EE0000000, !dbg !859 ; <float> [#uses=1]
  %tmp.12 = fadd float %tmp.7, %tmp.11, !dbg !859 ; <float> [#uses=1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float 0x3FAF253DA0000000) nounwind
  %tmp.13 = sext i32 %tmp6 to i64, !dbg !859      ; <i64> [#uses=3]
  %in.addr.2 = getelementptr inbounds [1920 x i16]* %in, i64 %tmp.2, i64 %tmp.13, !dbg !859 ; <i16*> [#uses=1]
  %in.load.2 = load i16* %in.addr.2, align 2, !dbg !859 ; <i16> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %in.load.2) nounwind
  %tmp.14 = zext i16 %in.load.2 to i32, !dbg !859 ; <i32> [#uses=1]
  %tmp.15 = sitofp i32 %tmp.14 to float, !dbg !859 ; <float> [#uses=1]
  %tmp.16 = fmul float %tmp.15, 0x3FAF253DA0000000, !dbg !859 ; <float> [#uses=1]
  %tmp.17 = fadd float %tmp.12, %tmp.16, !dbg !859 ; <float> [#uses=1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float 0x3FC3275EE0000000) nounwind
  %in.addr.3 = getelementptr inbounds [1920 x i16]* %in, i64 %tmp.1, i64 %tmp.4, !dbg !859 ; <i16*> [#uses=1]
  %in.load.3 = load i16* %in.addr.3, align 2, !dbg !859 ; <i16> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %in.load.3) nounwind
  %tmp.18 = zext i16 %in.load.3 to i32, !dbg !859 ; <i32> [#uses=1]
  %tmp.19 = sitofp i32 %tmp.18 to float, !dbg !859 ; <float> [#uses=1]
  %tmp.20 = fmul float %tmp.19, 0x3FC3275EE0000000, !dbg !859 ; <float> [#uses=1]
  %tmp.21 = fadd float %tmp.17, %tmp.20, !dbg !859 ; <float> [#uses=1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float 0x3FD78EE6C0000000) nounwind
  %in.addr.4 = getelementptr inbounds [1920 x i16]* %in, i64 %tmp.1, i64 %tmp.8, !dbg !859 ; <i16*> [#uses=1]
  %in.load.4 = load i16* %in.addr.4, align 2, !dbg !859 ; <i16> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %in.load.4) nounwind
  %tmp.22 = zext i16 %in.load.4 to i32, !dbg !859 ; <i32> [#uses=1]
  %tmp.23 = sitofp i32 %tmp.22 to float, !dbg !859 ; <float> [#uses=1]
  %tmp.24 = fmul float %tmp.23, 0x3FD78EE6C0000000, !dbg !859 ; <float> [#uses=1]
  %tmp.25 = fadd float %tmp.21, %tmp.24, !dbg !859 ; <float> [#uses=1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float 0x3FC3271360000000) nounwind
  %in.addr.5 = getelementptr inbounds [1920 x i16]* %in, i64 %tmp.1, i64 %tmp.13, !dbg !859 ; <i16*> [#uses=1]
  %in.load.5 = load i16* %in.addr.5, align 2, !dbg !859 ; <i16> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %in.load.5) nounwind
  %tmp.26 = zext i16 %in.load.5 to i32, !dbg !859 ; <i32> [#uses=1]
  %tmp.27 = sitofp i32 %tmp.26 to float, !dbg !859 ; <float> [#uses=1]
  %tmp.28 = fmul float %tmp.27, 0x3FC3271360000000, !dbg !859 ; <float> [#uses=1]
  %tmp.29 = fadd float %tmp.25, %tmp.28, !dbg !859 ; <float> [#uses=1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float 0x3FAF253DA0000000) nounwind
  %in.addr.6 = getelementptr inbounds [1920 x i16]* %in, i64 %tmp.3, i64 %tmp.4, !dbg !859 ; <i16*> [#uses=1]
  %in.load.6 = load i16* %in.addr.6, align 2, !dbg !859 ; <i16> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %in.load.6) nounwind
  %tmp.30 = zext i16 %in.load.6 to i32, !dbg !859 ; <i32> [#uses=1]
  %tmp.31 = sitofp i32 %tmp.30 to float, !dbg !859 ; <float> [#uses=1]
  %tmp.32 = fmul float %tmp.31, 0x3FAF253DA0000000, !dbg !859 ; <float> [#uses=1]
  %tmp.33 = fadd float %tmp.29, %tmp.32, !dbg !859 ; <float> [#uses=1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float 0x3FC3275EE0000000) nounwind
  %in.addr.7 = getelementptr inbounds [1920 x i16]* %in, i64 %tmp.3, i64 %tmp.8, !dbg !859 ; <i16*> [#uses=1]
  %in.load.7 = load i16* %in.addr.7, align 2, !dbg !859 ; <i16> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %in.load.7) nounwind
  %tmp.34 = zext i16 %in.load.7 to i32, !dbg !859 ; <i32> [#uses=1]
  %tmp.35 = sitofp i32 %tmp.34 to float, !dbg !859 ; <float> [#uses=1]
  %tmp.36 = fmul float %tmp.35, 0x3FC3275EE0000000, !dbg !859 ; <float> [#uses=1]
  %tmp.37 = fadd float %tmp.33, %tmp.36, !dbg !859 ; <float> [#uses=1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float 0x3FAF253DA0000000) nounwind
  %in.addr.8 = getelementptr inbounds [1920 x i16]* %in, i64 %tmp.3, i64 %tmp.13, !dbg !859 ; <i16*> [#uses=1]
  %in.load.8 = load i16* %in.addr.8, align 2, !dbg !859 ; <i16> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %in.load.8) nounwind
  %tmp.38 = zext i16 %in.load.8 to i32, !dbg !859 ; <i32> [#uses=1]
  %tmp.39 = sitofp i32 %tmp.38 to float, !dbg !859 ; <float> [#uses=1]
  %tmp.40 = fmul float %tmp.39, 0x3FAF253DA0000000, !dbg !859 ; <float> [#uses=1]
  %tmp.41 = fadd float %tmp.37, %tmp.40, !dbg !859 ; <float> [#uses=1]
  %tmp.42 = fptoui float %tmp.41 to i16, !dbg !859 ; <i16> [#uses=1]
  %out.addr = getelementptr inbounds [1920 x i16]* %out, i64 %tmp.1, i64 %tmp.8, !dbg !859 ; <i16*> [#uses=1]
  store i16 %tmp.42, i16* %out.addr, align 2, !dbg !859
  br label %bb2, !dbg !860

bb2:                                              ; preds = %bb2.preheader, %bb1
  %indvar = phi i32 [ 0, %bb2.preheader ], [ %j, %bb1 ], !dbg !859 ; <i32> [#uses=4]
  %tmp6 = add i32 %indvar, 2, !dbg !859           ; <i32> [#uses=1]
  %j = add i32 %indvar, 1, !dbg !860              ; <i32> [#uses=2]
  call void @llvm.dbg.value(metadata !{i32 %j}, i64 0, metadata !861), !dbg !860
  %exitcond5 = icmp eq i32 %indvar, 1918, !dbg !860 ; <i1> [#uses=1]
  br i1 %exitcond5, label %bb4.loopexit, label %bb1, !dbg !860

bb4.loopexit:                                     ; preds = %bb2
  br label %bb4

bb4:                                              ; preds = %bb4.loopexit, %entry
  %indvar1 = phi i32 [ 0, %entry ], [ %i, %bb4.loopexit ], !dbg !859 ; <i32> [#uses=4]
  %tmp = add i32 %indvar1, 2, !dbg !859           ; <i32> [#uses=1]
  %i = add i32 %indvar1, 1, !dbg !858             ; <i32> [#uses=2]
  call void @llvm.dbg.value(metadata !{i32 %i}, i64 0, metadata !863), !dbg !858
  %exitcond = icmp eq i32 %indvar1, 1078, !dbg !858 ; <i1> [#uses=1]
  br i1 %exitcond, label %return, label %bb2.preheader, !dbg !858

bb2.preheader:                                    ; preds = %bb4
  %tmp.1 = sext i32 %i to i64, !dbg !859          ; <i64> [#uses=4]
  %tmp.2 = sext i32 %indvar1 to i64, !dbg !859    ; <i64> [#uses=3]
  %tmp.3 = sext i32 %tmp to i64, !dbg !859        ; <i64> [#uses=3]
  br label %bb2
...
entry:
  call void @llvm.dbg.value(metadata !{[1920 x i16]* %in}, i64 0, metadata !865)
  call void @llvm.dbg.value(metadata !{[1920 x i16]* %out}, i64 0, metadata !874)
  call void (...)* @_ssdm_SpecArrayDimSize([1920 x i16]* %in, i32 1080) nounwind, !dbg !875
  call void (...)* @_ssdm_SpecArrayDimSize([1920 x i16]* %out, i32 1080) nounwind, !dbg !875
  call void (...)* @_ssdm_op_SpecMem([1920 x i16]* %in, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !877
  call void (...)* @_ssdm_op_SpecMem([1920 x i16]* %out, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !878
  call fastcc void @gaussian_3x3([1920 x i16]* %in, [1920 x i16]* %out) nounwind, !dbg !879
  ret void, !dbg !880
}
...
!845 = metadata !{i32 459009, metadata !846, metadata !"in", metadata !840, i32 7, metadata !849} ; [ DW_TAG_arg_variable ]
!846 = metadata !{i32 458798, i32 0, metadata !839, metadata !"gaussian_3x3", metadata !"gaussian_3x3", metadata !"_Z12gaussian_3x3PA1920_tS0_", metadata !840, i32 7, metadata !847, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!847 = metadata !{i32 458773, metadata !839, metadata !"", metadata !839, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !848, i32 0, null} ; [ DW_TAG_subroutine_type ]
!848 = metadata !{null, metadata !849, metadata !849}
!849 = metadata !{i32 458767, metadata !839, metadata !"", metadata !839, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !850} ; [ DW_TAG_pointer_type ]
!850 = metadata !{i32 458753, metadata !839, metadata !"", metadata !839, i32 0, i64 30720, i64 16, i64 0, i32 0, metadata !851, metadata !852, i32 0, null} ; [ DW_TAG_array_type ]
!851 = metadata !{i32 458788, metadata !839, metadata !"short unsigned int", metadata !839, i32 0, i64 16, i64 16, i64 0, i32 0, i32 7} ; [ DW_TAG_base_type ]
!852 = metadata !{metadata !853}
!853 = metadata !{i32 458785, i64 0, i64 1919}    ; [ DW_TAG_subrange_type ]
!854 = metadata !{i32 459009, metadata !846, metadata !"out", metadata !840, i32 7, metadata !849} ; [ DW_TAG_arg_variable ]
!855 = metadata !{i32 8, i32 0, metadata !856, null}
!856 = metadata !{i32 458763, metadata !857, i32 7, i32 0} ; [ DW_TAG_lexical_block ]
!857 = metadata !{i32 458763, metadata !846, i32 7, i32 0} ; [ DW_TAG_lexical_block ]
!858 = metadata !{i32 11, i32 0, metadata !856, null}
!859 = metadata !{i32 18, i32 0, metadata !856, null}
!860 = metadata !{i32 13, i32 0, metadata !856, null}
!861 = metadata !{i32 459008, metadata !856, metadata !"j", metadata !840, i32 9, metadata !862} ; [ DW_TAG_auto_variable ]
!862 = metadata !{i32 458788, metadata !839, metadata !"int", metadata !839, i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!863 = metadata !{i32 459008, metadata !856, metadata !"i", metadata !840, i32 9, metadata !862} ; [ DW_TAG_auto_variable ]
!864 = metadata !{i32 21, i32 0, metadata !856, null}
!865 = metadata !{i32 459009, metadata !866, metadata !"in", metadata !868, i32 4, metadata !871} ; [ DW_TAG_arg_variable ]
!866 = metadata !{i32 458798, i32 0, metadata !867, metadata !"gaussian", metadata !"gaussian", metadata !"_Z8gaussianPA1920_tS0_", metadata !868, i32 4, metadata !869, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!867 = metadata !{i32 458769, i32 0, i32 4, metadata !"gaussian.pragma.2.cpp", metadata !"/users/deastir/mcaceres/Documents/VIVADO/TP_Vivado_HLS/TP_Vivado_HLS/gaussian/solution1/.autopilot/db", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.7)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
!868 = metadata !{i32 458769, i32 0, i32 4, metadata !"gaussian.cpp", metadata !"/users/deastir/mcaceres/Documents/VIVADO/TP_Vivado_HLS/TP_Vivado_HLS/src", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.7)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
!869 = metadata !{i32 458773, metadata !867, metadata !"", metadata !867, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !870, i32 0, null} ; [ DW_TAG_subroutine_type ]
!870 = metadata !{null, metadata !871, metadata !871}
!871 = metadata !{i32 458767, metadata !867, metadata !"", metadata !867, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !872} ; [ DW_TAG_pointer_type ]
!872 = metadata !{i32 458753, metadata !867, metadata !"", metadata !867, i32 0, i64 30720, i64 16, i64 0, i32 0, metadata !873, metadata !852, i32 0, null} ; [ DW_TAG_array_type ]
!873 = metadata !{i32 458788, metadata !867, metadata !"short unsigned int", metadata !867, i32 0, i64 16, i64 16, i64 0, i32 0, i32 7} ; [ DW_TAG_base_type ]
!874 = metadata !{i32 459009, metadata !866, metadata !"out", metadata !868, i32 4, metadata !871} ; [ DW_TAG_arg_variable ]
!875 = metadata !{i32 5, i32 0, metadata !876, null}
!876 = metadata !{i32 458763, metadata !866, i32 4, i32 0} ; [ DW_TAG_lexical_block ]
!877 = metadata !{i32 6, i32 0, metadata !876, null}
!878 = metadata !{i32 7, i32 0, metadata !876, null}
!879 = metadata !{i32 8, i32 0, metadata !876, null}
!880 = metadata !{i32 15, i32 0, metadata !876, null}
