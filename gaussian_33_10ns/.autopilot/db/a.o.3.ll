...
entry:
  call void @llvm.dbg.value(metadata !{[2073600 x i16]* %in}, i64 0, metadata !845)
  call void @llvm.dbg.value(metadata !{[2073600 x i16]* %out}, i64 0, metadata !859)
  call void (...)* @_ssdm_op_SpecMem([2073600 x i16]* %in, [10 x i8]* @p_str, i32 0, i32 0, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !860
  call void (...)* @_ssdm_op_SpecMem([2073600 x i16]* %out, [10 x i8]* @p_str, i32 0, i32 0, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !862
  call void @llvm.dbg.value(metadata !{[2073600 x i16]* %in}, i64 0, metadata !863) nounwind
  call void @llvm.dbg.value(metadata !{[2073600 x i16]* %out}, i64 0, metadata !871) nounwind
  br label %bb4.i, !dbg !872

bb1.i:                                            ; preds = %bb2.i
  %tmp_4_i_trn_cast = zext i11 %indvar_i to i24   ; <i24> [#uses=3]
  %tmp = call i22 @_ssdm_op_BitConcatenate.i22.i11.i11(i11 %indvar1_i, i11 0) ; <i22> [#uses=1]
  %p_shl_cast = zext i22 %tmp to i23              ; <i23> [#uses=1]
  %tmp_1 = call i18 @_ssdm_op_BitConcatenate.i18.i11.i7(i11 %indvar1_i, i7 0) ; <i18> [#uses=1]
  %p_shl1_cast = zext i18 %tmp_1 to i23, !dbg !876 ; <i23> [#uses=1]
  %p_addr = sub i23 %p_shl_cast, %p_shl1_cast, !dbg !876 ; <i23> [#uses=1]
  %p_addr_cast = sext i23 %p_addr to i24, !dbg !876 ; <i24> [#uses=3]
  %p_addr2 = add i24 %p_addr_cast, %tmp_4_i_trn_cast, !dbg !876 ; <i24> [#uses=1]
  %p_addr2_cast = sext i24 %p_addr2 to i32, !dbg !876 ; <i32> [#uses=1]
  %tmp_2 = zext i32 %p_addr2_cast to i64          ; <i64> [#uses=1]
  %in_addr = getelementptr [2073600 x i16]* %in, i64 0, i64 %tmp_2, !dbg !876 ; <i16*> [#uses=1]
  %in_load = load i16* %in_addr, align 2, !dbg !876 ; <i16> [#uses=1]
  %tmp_6_i3 = zext i16 %in_load to i64, !dbg !876 ; <i64> [#uses=1]
  %tmp_6_i = sitofp i64 %tmp_6_i3 to float, !dbg !876 ; <float> [#uses=1]
  %tmp_7_i = fmul float %tmp_6_i, 0x3FAF253DA0000000, !dbg !876 ; <float> [#uses=1]
  %tmp_8_i_trn_cast = zext i11 %j to i24, !dbg !876 ; <i24> [#uses=3]
  %p_addr3 = add i24 %p_addr_cast, %tmp_8_i_trn_cast, !dbg !876 ; <i24> [#uses=1]
  %p_addr3_cast = sext i24 %p_addr3 to i32, !dbg !876 ; <i32> [#uses=1]
  %tmp_3 = zext i32 %p_addr3_cast to i64          ; <i64> [#uses=1]
  %in_addr_1 = getelementptr [2073600 x i16]* %in, i64 0, i64 %tmp_3, !dbg !876 ; <i16*> [#uses=1]
  %in_load_1 = load i16* %in_addr_1, align 2, !dbg !876 ; <i16> [#uses=1]
  %tmp_i4 = zext i16 %in_load_1 to i64, !dbg !876 ; <i64> [#uses=1]
  %tmp_i = sitofp i64 %tmp_i4 to float, !dbg !876 ; <float> [#uses=1]
  %tmp_10_i = fmul float %tmp_i, 0x3FC3275EE0000000, !dbg !876 ; <float> [#uses=1]
  %tmp_11_i = fadd float %tmp_7_i, %tmp_10_i, !dbg !876 ; <float> [#uses=1]
  %tmp_12_i_trn_cast = zext i11 %tmp6_i to i24, !dbg !876 ; <i24> [#uses=3]
  %p_addr5 = add i24 %p_addr_cast, %tmp_12_i_trn_cast, !dbg !876 ; <i24> [#uses=1]
  %p_addr5_cast = sext i24 %p_addr5 to i32, !dbg !876 ; <i32> [#uses=1]
  %tmp_4 = zext i32 %p_addr5_cast to i64          ; <i64> [#uses=1]
  %in_addr_2 = getelementptr [2073600 x i16]* %in, i64 0, i64 %tmp_4, !dbg !876 ; <i16*> [#uses=1]
  %in_load_2 = load i16* %in_addr_2, align 2, !dbg !876 ; <i16> [#uses=1]
  %tmp_14_i5 = zext i16 %in_load_2 to i64, !dbg !876 ; <i64> [#uses=1]
  %tmp_14_i = sitofp i64 %tmp_14_i5 to float, !dbg !876 ; <float> [#uses=1]
  %tmp_15_i = fmul float %tmp_14_i, 0x3FAF253DA0000000, !dbg !876 ; <float> [#uses=1]
  %tmp_16_i = fadd float %tmp_11_i, %tmp_15_i, !dbg !876 ; <float> [#uses=1]
  %tmp_5 = call i22 @_ssdm_op_BitConcatenate.i22.i11.i11(i11 %i, i11 0) ; <i22> [#uses=1]
  %p_shl2_cast = zext i22 %tmp_5 to i23           ; <i23> [#uses=1]
  %tmp_6 = call i18 @_ssdm_op_BitConcatenate.i18.i11.i7(i11 %i, i7 0) ; <i18> [#uses=1]
  %p_shl3_cast = zext i18 %tmp_6 to i23, !dbg !876 ; <i23> [#uses=1]
  %p_addr8 = sub i23 %p_shl2_cast, %p_shl3_cast, !dbg !876 ; <i23> [#uses=1]
  %p_addr8_cast = sext i23 %p_addr8 to i24, !dbg !876 ; <i24> [#uses=3]
  %p_addr9 = add i24 %p_addr8_cast, %tmp_4_i_trn_cast, !dbg !876 ; <i24> [#uses=1]
  %p_addr9_cast = sext i24 %p_addr9 to i32, !dbg !876 ; <i32> [#uses=1]
  %tmp_7 = zext i32 %p_addr9_cast to i64          ; <i64> [#uses=1]
  %in_addr_3 = getelementptr [2073600 x i16]* %in, i64 0, i64 %tmp_7, !dbg !876 ; <i16*> [#uses=1]
  %in_load_3 = load i16* %in_addr_3, align 2, !dbg !876 ; <i16> [#uses=1]
  %tmp_18_i6 = zext i16 %in_load_3 to i64, !dbg !876 ; <i64> [#uses=1]
  %tmp_18_i = sitofp i64 %tmp_18_i6 to float, !dbg !876 ; <float> [#uses=1]
  %tmp_19_i = fmul float %tmp_18_i, 0x3FC3275EE0000000, !dbg !876 ; <float> [#uses=1]
  %tmp_20_i = fadd float %tmp_16_i, %tmp_19_i, !dbg !876 ; <float> [#uses=1]
  %p_addr11 = add i24 %p_addr8_cast, %tmp_8_i_trn_cast, !dbg !876 ; <i24> [#uses=1]
  %p_addr11_cast = sext i24 %p_addr11 to i32, !dbg !876 ; <i32> [#uses=1]
  %tmp_8 = zext i32 %p_addr11_cast to i64         ; <i64> [#uses=2]
  %in_addr_4 = getelementptr [2073600 x i16]* %in, i64 0, i64 %tmp_8, !dbg !876 ; <i16*> [#uses=1]
  %in_load_4 = load i16* %in_addr_4, align 2, !dbg !876 ; <i16> [#uses=1]
  %tmp_22_i7 = zext i16 %in_load_4 to i64, !dbg !876 ; <i64> [#uses=1]
  %tmp_22_i = sitofp i64 %tmp_22_i7 to float, !dbg !876 ; <float> [#uses=1]
  %tmp_23_i = fmul float %tmp_22_i, 0x3FD78EE6C0000000, !dbg !876 ; <float> [#uses=1]
  %tmp_24_i = fadd float %tmp_20_i, %tmp_23_i, !dbg !876 ; <float> [#uses=1]
  %p_addr10 = add i24 %p_addr8_cast, %tmp_12_i_trn_cast, !dbg !876 ; <i24> [#uses=1]
  %p_addr10_cast = sext i24 %p_addr10 to i32, !dbg !876 ; <i32> [#uses=1]
  %tmp_9 = zext i32 %p_addr10_cast to i64         ; <i64> [#uses=1]
  %in_addr_5 = getelementptr [2073600 x i16]* %in, i64 0, i64 %tmp_9, !dbg !876 ; <i16*> [#uses=1]
  %in_load_5 = load i16* %in_addr_5, align 2, !dbg !876 ; <i16> [#uses=1]
  %tmp_26_i8 = zext i16 %in_load_5 to i64, !dbg !876 ; <i64> [#uses=1]
  %tmp_26_i = sitofp i64 %tmp_26_i8 to float, !dbg !876 ; <float> [#uses=1]
  %tmp_27_i = fmul float %tmp_26_i, 0x3FC3271360000000, !dbg !876 ; <float> [#uses=1]
  %tmp_28_i = fadd float %tmp_24_i, %tmp_27_i, !dbg !876 ; <float> [#uses=1]
  %tmp_s = call i22 @_ssdm_op_BitConcatenate.i22.i11.i11(i11 %tmp_i_12, i11 0) ; <i22> [#uses=1]
  %p_shl4_cast = zext i22 %tmp_s to i23           ; <i23> [#uses=1]
  %tmp_10 = call i18 @_ssdm_op_BitConcatenate.i18.i11.i7(i11 %tmp_i_12, i7 0) ; <i18> [#uses=1]
  %p_shl5_cast = zext i18 %tmp_10 to i23, !dbg !876 ; <i23> [#uses=1]
  %p_addr6 = sub i23 %p_shl4_cast, %p_shl5_cast, !dbg !876 ; <i23> [#uses=1]
  %p_addr6_cast = sext i23 %p_addr6 to i24, !dbg !876 ; <i24> [#uses=3]
  %p_addr7 = add i24 %p_addr6_cast, %tmp_4_i_trn_cast, !dbg !876 ; <i24> [#uses=1]
  %p_addr7_cast = sext i24 %p_addr7 to i32, !dbg !876 ; <i32> [#uses=1]
  %tmp_11 = zext i32 %p_addr7_cast to i64         ; <i64> [#uses=1]
  %in_addr_6 = getelementptr [2073600 x i16]* %in, i64 0, i64 %tmp_11, !dbg !876 ; <i16*> [#uses=1]
  %in_load_6 = load i16* %in_addr_6, align 2, !dbg !876 ; <i16> [#uses=1]
  %tmp_30_i9 = zext i16 %in_load_6 to i64, !dbg !876 ; <i64> [#uses=1]
  %tmp_30_i = sitofp i64 %tmp_30_i9 to float, !dbg !876 ; <float> [#uses=1]
  %tmp_31_i = fmul float %tmp_30_i, 0x3FAF253DA0000000, !dbg !876 ; <float> [#uses=1]
  %tmp_32_i = fadd float %tmp_28_i, %tmp_31_i, !dbg !876 ; <float> [#uses=1]
  %p_addr4 = add i24 %p_addr6_cast, %tmp_8_i_trn_cast, !dbg !876 ; <i24> [#uses=1]
  %p_addr4_cast = sext i24 %p_addr4 to i32, !dbg !876 ; <i32> [#uses=1]
  %tmp_12 = zext i32 %p_addr4_cast to i64         ; <i64> [#uses=1]
  %in_addr_7 = getelementptr [2073600 x i16]* %in, i64 0, i64 %tmp_12, !dbg !876 ; <i16*> [#uses=1]
  %in_load_7 = load i16* %in_addr_7, align 2, !dbg !876 ; <i16> [#uses=1]
  %tmp_34_i1 = zext i16 %in_load_7 to i64, !dbg !876 ; <i64> [#uses=1]
  %tmp_34_i = sitofp i64 %tmp_34_i1 to float, !dbg !876 ; <float> [#uses=1]
  %tmp_35_i = fmul float %tmp_34_i, 0x3FC3275EE0000000, !dbg !876 ; <float> [#uses=1]
  %tmp_36_i = fadd float %tmp_32_i, %tmp_35_i, !dbg !876 ; <float> [#uses=1]
  %p_addr1 = add i24 %p_addr6_cast, %tmp_12_i_trn_cast, !dbg !876 ; <i24> [#uses=1]
  %p_addr1_cast = sext i24 %p_addr1 to i32, !dbg !876 ; <i32> [#uses=1]
  %tmp_13 = zext i32 %p_addr1_cast to i64         ; <i64> [#uses=1]
  %in_addr_8 = getelementptr [2073600 x i16]* %in, i64 0, i64 %tmp_13, !dbg !876 ; <i16*> [#uses=1]
  %in_load_8 = load i16* %in_addr_8, align 2, !dbg !876 ; <i16> [#uses=1]
  %tmp_38_i1 = zext i16 %in_load_8 to i64, !dbg !876 ; <i64> [#uses=1]
  %tmp_38_i = sitofp i64 %tmp_38_i1 to float, !dbg !876 ; <float> [#uses=1]
  %tmp_39_i = fmul float %tmp_38_i, 0x3FAF253DA0000000, !dbg !876 ; <float> [#uses=1]
  %tmp_40_i = fadd float %tmp_36_i, %tmp_39_i, !dbg !876 ; <float> [#uses=1]
  %tmp_41_i = fptoui float %tmp_40_i to i64, !dbg !876 ; <i64> [#uses=1]
  %tmp_14 = trunc i64 %tmp_41_i to i16, !dbg !876 ; <i16> [#uses=1]
  %out_addr = getelementptr [2073600 x i16]* %out, i64 0, i64 %tmp_8, !dbg !876 ; <i16*> [#uses=1]
  store i16 %tmp_14, i16* %out_addr, align 2, !dbg !876
  br label %bb2.i, !dbg !877

bb2.i:                                            ; preds = %bb4.i, %bb1.i
  %indvar_i = phi i11 [ %j, %bb1.i ], [ 0, %bb4.i ] ; <i11> [#uses=4]
  %tmp6_i = add i11 %indvar_i, 2, !dbg !876       ; <i11> [#uses=1]
  %j = add i11 %indvar_i, 1, !dbg !877            ; <i11> [#uses=2]
  ...
  %exitcond1 = icmp eq i11 %indvar_i, -130, !dbg !877 ; <i1> [#uses=1]
  br i1 %exitcond1, label %bb4.i, label %bb1.i, !dbg !877

bb4.i:                                            ; preds = %bb2.i, %entry
  %indvar1_i = phi i11 [ 0, %entry ], [ %i, %bb2.i ] ; <i11> [#uses=5]
  %tmp_i_12 = add i11 %indvar1_i, 2, !dbg !876    ; <i11> [#uses=2]
  %i = add i11 %indvar1_i, 1, !dbg !872           ; <i11> [#uses=3]
  call void @llvm.dbg.value(metadata !{i11 %i}, i64 0, metadata !880) nounwind, !dbg !872
  %empty_13 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 1078, i64 1078, i64 1078) nounwind ; <i32> [#uses=0]
  %exitcond = icmp eq i11 %indvar1_i, -970, !dbg !872 ; <i1> [#uses=1]
  br i1 %exitcond, label %gaussian_3x3.exit, label %bb2.i, !dbg !872
...
entry:
  ...
  %empty_14 = zext i11 %1 to i22                  ; <i22> [#uses=2]
  %empty_15 = trunc i22 %empty to i11             ; <i11> [#uses=1]
  %empty_16 = call i11 @_ssdm_op_PartSelect.i11.i22.i32.i32(i22 %empty_14, i32 11, i32 21) ; <i11> [#uses=1]
  %empty_17 = or i11 %empty_15, %empty_16         ; <i11> [#uses=1]
  %empty_18 = call i22 @_ssdm_op_PartSet.i22.i22.i11.i32.i32(i22 %empty_14, i11 %empty_17, i32 11, i32 21) ; <i22> [#uses=1]
  ret i22 %empty_18
}
...
entry:
  ...
  %empty_19 = zext i7 %1 to i18                   ; <i18> [#uses=2]
  %empty_20 = trunc i18 %empty to i11             ; <i11> [#uses=1]
  %empty_21 = call i11 @_ssdm_op_PartSelect.i11.i18.i32.i32(i18 %empty_19, i32 7, i32 17) ; <i11> [#uses=1]
  %empty_22 = or i11 %empty_20, %empty_21         ; <i11> [#uses=1]
  %empty_23 = call i18 @_ssdm_op_PartSet.i18.i18.i11.i32.i32(i18 %empty_19, i11 %empty_22, i32 7, i32 17) ; <i18> [#uses=1]
  ret i18 %empty_23
}
...
entry:
  ...
  %empty_24 = trunc i22 %empty to i11             ; <i11> [#uses=1]
  ret i11 %empty_24
}
