...
set id 1
set name gaussian_fadd_32ns_32ns_32_5_full_dsp
...
set id 2
set name gaussian_fmul_32ns_32ns_32_4_max_dsp
...
set id 4
set name gaussian_fptoui_32ns_64_4
set corename simcore_fptoui
set op fptoui
set stage_num 4
set registered_input 1
set in0_width 32
...
set out_width 64
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_fptoui] == "ap_gen_simcore_fptoui"} {
eval "ap_gen_simcore_fptoui { \
    id ${id} \
    name ${name} \
    corename ${corename} \
    op ${op} \
...
puts "@W \[IMPL-100\] Cannot find ap_gen_simcore_fptoui, check your AutoPilot builtin lib"
}
}
...
set id 5
set name gaussian_sitofp_64ns_32_6
...
set ID 7
set MemName gaussian_sep_tmp
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 32
set AddrRange 2073600
set AddrWd 21
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename in_r \
    op interface \
    ports { in_r_address0 { O 21 vector } in_r_ce0 { O 1 bit } in_r_q0 { I 16 vector } in_r_address1 { O 21 vector } in_r_ce1 { O 1 bit } in_r_q1 { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename out_r \
    op interface \
    ports { out_r_address0 { O 21 vector } out_r_ce0 { O 1 bit } out_r_we0 { O 1 bit } out_r_d0 { O 16 vector } } \
} "
} else {
