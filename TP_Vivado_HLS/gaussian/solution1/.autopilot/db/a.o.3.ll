...
entry:
  ...
  call void (...)* @_ssdm_op_SpecMem([2073600 x i16]* %in, [10 x i8]* @p_str9, i32 0, i32 0, i32 0, [1 x i8]* @p_str110) nounwind, !dbg !20
  call void (...)* @_ssdm_op_SpecMem([2073600 x i16]* %out, [10 x i8]* @p_str9, i32 0, i32 0, i32 0, [1 x i8]* @p_str110) nounwind, !dbg !22
