...
entry:
  call void @llvm.dbg.value(metadata !{[1920 x i16]* %in}, i64 0, metadata !871)
  ...
  call void (...)* @_ssdm_op_SpecMem([1920 x i16]* %in, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !883
  call void (...)* @_ssdm_op_SpecMem([1920 x i16]* %out, i8* getelementptr inbounds ([10 x i8]* @.str, i64 0, i64 0), i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !884
  call fastcc void @gaussian_1line([1920 x i16]* %in, [1920 x i16]* %out) nounwind, !dbg !885
  ret void, !dbg !886
}
...
define internal fastcc void @gaussian_1line([1920 x i16]* %in, [1920 x i16]* %out) nounwind {
entry:
  call void @llvm.dbg.value(metadata !{[1920 x i16]* %in}, i64 0, metadata !887)
...
bb:                                               ; preds = %bb4
  ...
  %tmp.1 = sext i32 %indvar1 to i64, !dbg !899    ; <i64> [#uses=3]
  %in.addr = getelementptr inbounds [1920 x i16]* %in, i64 %tmp.1, i64 0, !dbg !899 ; <i16*> [#uses=1]
  %in.load = load i16* %in.addr, align 2, !dbg !899 ; <i16> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %in.load) nounwind
  %tmp.2 = zext i16 %in.load to i32, !dbg !899    ; <i32> [#uses=1]
  %tmp.3 = sitofp i32 %tmp.2 to float, !dbg !899  ; <float> [#uses=1]
  %tmp.4 = fmul float %tmp.3, 0x3FCF91E640000000, !dbg !899 ; <float> [#uses=1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float 0x3FE36A2B20000000) nounwind
  %tmp.5 = sext i32 %i to i64, !dbg !899          ; <i64> [#uses=4]
  %in.addr.1 = getelementptr inbounds [1920 x i16]* %in, i64 %tmp.5, i64 0, !dbg !899 ; <i16*> [#uses=1]
  %in.load.1 = load i16* %in.addr.1, align 2, !dbg !899 ; <i16> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %in.load.1) nounwind
  %tmp.6 = zext i16 %in.load.1 to i32, !dbg !899  ; <i32> [#uses=1]
  %tmp.7 = sitofp i32 %tmp.6 to float, !dbg !899  ; <float> [#uses=1]
  %tmp.8 = fmul float %tmp.7, 0x3FE36A2B20000000, !dbg !899 ; <float> [#uses=1]
  %tmp.9 = fadd float %tmp.4, %tmp.8, !dbg !899   ; <float> [#uses=1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float 0x3FCF91E640000000) nounwind
  %tmp.10 = sext i32 %tmp to i64, !dbg !899       ; <i64> [#uses=3]
  %in.addr.2 = getelementptr inbounds [1920 x i16]* %in, i64 %tmp.10, i64 0, !dbg !899 ; <i16*> [#uses=1]
  %in.load.2 = load i16* %in.addr.2, align 2, !dbg !899 ; <i16> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %in.load.2) nounwind
  %tmp.11 = zext i16 %in.load.2 to i32, !dbg !899 ; <i32> [#uses=1]
  %tmp.12 = sitofp i32 %tmp.11 to float, !dbg !899 ; <float> [#uses=1]
  %tmp.13 = fmul float %tmp.12, 0x3FCF91E640000000, !dbg !899 ; <float> [#uses=1]
  %tmp.14 = fadd float %tmp.9, %tmp.13, !dbg !899 ; <float> [#uses=1]
  store float %tmp.14, float* getelementptr inbounds ([1920 x float]* @tmp, i64 0, i64 0), align 32, !dbg !899
  call void (...)* @_ssdm_SpecKeepArrayLoad(float 0x3FCF91E640000000) nounwind
  %in.addr.3 = getelementptr inbounds [1920 x i16]* %in, i64 %tmp.1, i64 1, !dbg !900 ; <i16*> [#uses=1]
  %in.load.3 = load i16* %in.addr.3, align 2, !dbg !900 ; <i16> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %in.load.3) nounwind
  %tmp.15 = zext i16 %in.load.3 to i32, !dbg !900 ; <i32> [#uses=1]
  %tmp.16 = sitofp i32 %tmp.15 to float, !dbg !900 ; <float> [#uses=1]
  %tmp.17 = fmul float %tmp.16, 0x3FCF91E640000000, !dbg !900 ; <float> [#uses=1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float 0x3FE36A2B20000000) nounwind
  %in.addr.4 = getelementptr inbounds [1920 x i16]* %in, i64 %tmp.5, i64 1, !dbg !900 ; <i16*> [#uses=1]
  %in.load.4 = load i16* %in.addr.4, align 2, !dbg !900 ; <i16> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %in.load.4) nounwind
  %tmp.18 = zext i16 %in.load.4 to i32, !dbg !900 ; <i32> [#uses=1]
  %tmp.19 = sitofp i32 %tmp.18 to float, !dbg !900 ; <float> [#uses=1]
  %tmp.20 = fmul float %tmp.19, 0x3FE36A2B20000000, !dbg !900 ; <float> [#uses=1]
  %tmp.21 = fadd float %tmp.17, %tmp.20, !dbg !900 ; <float> [#uses=1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float 0x3FCF91E640000000) nounwind
  %in.addr.5 = getelementptr inbounds [1920 x i16]* %in, i64 %tmp.10, i64 1, !dbg !900 ; <i16*> [#uses=1]
  %in.load.5 = load i16* %in.addr.5, align 2, !dbg !900 ; <i16> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %in.load.5) nounwind
  %tmp.22 = zext i16 %in.load.5 to i32, !dbg !900 ; <i32> [#uses=1]
  %tmp.23 = sitofp i32 %tmp.22 to float, !dbg !900 ; <float> [#uses=1]
  %tmp.24 = fmul float %tmp.23, 0x3FCF91E640000000, !dbg !900 ; <float> [#uses=1]
  %tmp.25 = fadd float %tmp.21, %tmp.24, !dbg !900 ; <float> [#uses=1]
  store float %tmp.25, float* getelementptr inbounds ([1920 x float]* @tmp, i64 0, i64 1), align 4, !dbg !900
  br label %bb2, !dbg !901

bb1:                                              ; preds = %bb2
  call void (...)* @_ssdm_SpecKeepArrayLoad(float 0x3FCF91E640000000) nounwind
  %tmp.26 = sext i32 %j to i64, !dbg !902         ; <i64> [#uses=4]
  %in.addr.6 = getelementptr inbounds [1920 x i16]* %in, i64 %tmp.1, i64 %tmp.26, !dbg !902 ; <i16*> [#uses=1]
  %in.load.6 = load i16* %in.addr.6, align 2, !dbg !902 ; <i16> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %in.load.6) nounwind
  %tmp.27 = zext i16 %in.load.6 to i32, !dbg !902 ; <i32> [#uses=1]
  %tmp.28 = sitofp i32 %tmp.27 to float, !dbg !902 ; <float> [#uses=1]
  %tmp.29 = fmul float %tmp.28, 0x3FCF91E640000000, !dbg !902 ; <float> [#uses=1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float 0x3FE36A2B20000000) nounwind
  %in.addr.7 = getelementptr inbounds [1920 x i16]* %in, i64 %tmp.5, i64 %tmp.26, !dbg !902 ; <i16*> [#uses=1]
  %in.load.7 = load i16* %in.addr.7, align 2, !dbg !902 ; <i16> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %in.load.7) nounwind
  %tmp.30 = zext i16 %in.load.7 to i32, !dbg !902 ; <i32> [#uses=1]
  %tmp.31 = sitofp i32 %tmp.30 to float, !dbg !902 ; <float> [#uses=1]
  %tmp.32 = fmul float %tmp.31, 0x3FE36A2B20000000, !dbg !902 ; <float> [#uses=1]
  %tmp.33 = fadd float %tmp.29, %tmp.32, !dbg !902 ; <float> [#uses=1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float 0x3FCF91E640000000) nounwind
  %in.addr.8 = getelementptr inbounds [1920 x i16]* %in, i64 %tmp.10, i64 %tmp.26, !dbg !902 ; <i16*> [#uses=1]
  %in.load.8 = load i16* %in.addr.8, align 2, !dbg !902 ; <i16> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i16 %in.load.8) nounwind
  %tmp.34 = zext i16 %in.load.8 to i32, !dbg !902 ; <i32> [#uses=1]
  %tmp.35 = sitofp i32 %tmp.34 to float, !dbg !902 ; <float> [#uses=1]
  %tmp.36 = fmul float %tmp.35, 0x3FCF91E640000000, !dbg !902 ; <float> [#uses=1]
  %tmp.37 = fadd float %tmp.33, %tmp.36, !dbg !902 ; <float> [#uses=3]
  %tmp.addr = getelementptr inbounds [1920 x float]* @tmp, i64 0, i64 %tmp.26, !dbg !902 ; <float*> [#uses=1]
  store float %tmp.37, float* %tmp.addr, align 4, !dbg !902
  call void (...)* @_ssdm_SpecKeepArrayLoad(float 0x3FCF91E640000000) nounwind
  %tmp.38 = sext i32 %indvar to i64, !dbg !903    ; <i64> [#uses=1]
  %tmp.addr.1 = getelementptr inbounds [1920 x float]* @tmp, i64 0, i64 %tmp.38, !dbg !903 ; <float*> [#uses=1]
  %0 = load float* %tmp.addr.1, align 4, !dbg !903 ; <float> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %0) nounwind
  %tmp.39 = fmul float %0, 0x3FCF91E640000000, !dbg !903 ; <float> [#uses=1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float 0x3FE36A2B20000000) nounwind
  %tmp.40 = sext i32 %tmp6 to i64, !dbg !903      ; <i64> [#uses=2]
  %tmp.addr.2 = getelementptr inbounds [1920 x float]* @tmp, i64 0, i64 %tmp.40, !dbg !903 ; <float*> [#uses=1]
  %1 = load float* %tmp.addr.2, align 4, !dbg !903 ; <float> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %1) nounwind
  %tmp.41 = fmul float %1, 0x3FE36A2B20000000, !dbg !903 ; <float> [#uses=1]
  %tmp.42 = fadd float %tmp.39, %tmp.41, !dbg !903 ; <float> [#uses=1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(float 0x3FCF91E640000000) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(float %tmp.37) nounwind
  %tmp.43 = fmul float %tmp.37, 0x3FCF91E640000000, !dbg !903 ; <float> [#uses=1]
  %tmp.44 = fadd float %tmp.42, %tmp.43, !dbg !903 ; <float> [#uses=1]
  %tmp.45 = fptoui float %tmp.44 to i16, !dbg !903 ; <i16> [#uses=1]
  %out.addr = getelementptr inbounds [1920 x i16]* %out, i64 %tmp.5, i64 %tmp.40, !dbg !903 ; <i16*> [#uses=1]
  store i16 %tmp.45, i16* %out.addr, align 2, !dbg !903
  br label %bb2, !dbg !901

bb2:                                              ; preds = %bb1, %bb
  %indvar = phi i32 [ %tmp6, %bb1 ], [ 0, %bb ], !dbg !903 ; <i32> [#uses=4]
  %tmp6 = add i32 %indvar, 1, !dbg !903           ; <i32> [#uses=2]
  %j = add i32 %indvar, 2, !dbg !901              ; <i32> [#uses=1]
  call void @llvm.dbg.value(metadata !{i32 %j}, i64 0, metadata !904), !dbg !901
  %exitcond5 = icmp eq i32 %indvar, 1918, !dbg !901 ; <i1> [#uses=1]
  br i1 %exitcond5, label %bb4.loopexit, label %bb1, !dbg !901

bb4.loopexit:                                     ; preds = %bb2
  br label %bb4

bb4:                                              ; preds = %bb4.loopexit, %entry
  %indvar1 = phi i32 [ 0, %entry ], [ %i, %bb4.loopexit ], !dbg !899 ; <i32> [#uses=4]
  %tmp = add i32 %indvar1, 2, !dbg !899           ; <i32> [#uses=1]
  %i = add i32 %indvar1, 1, !dbg !898             ; <i32> [#uses=2]
  call void @llvm.dbg.value(metadata !{i32 %i}, i64 0, metadata !906), !dbg !898
  %exitcond = icmp eq i32 %indvar1, 1079, !dbg !898 ; <i1> [#uses=1]
  br i1 %exitcond, label %return, label %bb, !dbg !898
...
!llvm.dbg.gv = !{!0, !7, !11, !17, !855, !860, !864, !869}
...
!864 = metadata !{i32 458804, i32 0, metadata !865, metadata !"k", metadata !"k", metadata !"", metadata !866, i32 11, metadata !867, i1 true, i1 true, null} ; [ DW_TAG_variable ]
!865 = metadata !{i32 458769, i32 0, i32 4, metadata !"gaussian_sep.pragma.2.cpp", metadata !"/users/deastir/mcaceres/Documents/VIVADO/TP_Vivado_HLS/TP_Vivado_HLS/gaussian/solution1/.autopilot/db", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.7)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
!866 = metadata !{i32 458769, i32 0, i32 4, metadata !"gaussian_sep.cpp", metadata !"/users/deastir/mcaceres/Documents/VIVADO/TP_Vivado_HLS/TP_Vivado_HLS/src", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.7)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!869 = metadata !{i32 458804, i32 0, metadata !865, metadata !"tmp", metadata !"tmp", metadata !"", metadata !866, i32 14, metadata !870, i1 true, i1 true, null} ; [ DW_TAG_variable ]
!870 = metadata !{i32 458753, metadata !865, metadata !"", metadata !865, i32 0, i64 66355200, i64 32, i64 0, i32 0, metadata !868, metadata !862, i32 0, null} ; [ DW_TAG_array_type ]
!871 = metadata !{i32 459009, metadata !872, metadata !"in", metadata !874, i32 4, metadata !877} ; [ DW_TAG_arg_variable ]
!872 = metadata !{i32 458798, i32 0, metadata !873, metadata !"gaussian", metadata !"gaussian", metadata !"_Z8gaussianPA1920_tS0_", metadata !874, i32 4, metadata !875, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!873 = metadata !{i32 458769, i32 0, i32 4, metadata !"gaussian.pragma.2.cpp", metadata !"/users/deastir/mcaceres/Documents/VIVADO/TP_Vivado_HLS/TP_Vivado_HLS/gaussian/solution1/.autopilot/db", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.7)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
!874 = metadata !{i32 458769, i32 0, i32 4, metadata !"gaussian.cpp", metadata !"/users/deastir/mcaceres/Documents/VIVADO/TP_Vivado_HLS/TP_Vivado_HLS/src", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.7)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
!875 = metadata !{i32 458773, metadata !873, metadata !"", metadata !873, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !876, i32 0, null} ; [ DW_TAG_subroutine_type ]
!876 = metadata !{null, metadata !877, metadata !877}
!877 = metadata !{i32 458767, metadata !873, metadata !"", metadata !873, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !878} ; [ DW_TAG_pointer_type ]
!878 = metadata !{i32 458753, metadata !873, metadata !"", metadata !873, i32 0, i64 30720, i64 16, i64 0, i32 0, metadata !879, metadata !9, i32 0, null} ; [ DW_TAG_array_type ]
!879 = metadata !{i32 458788, metadata !873, metadata !"short unsigned int", metadata !873, i32 0, i64 16, i64 16, i64 0, i32 0, i32 7} ; [ DW_TAG_base_type ]
!880 = metadata !{i32 459009, metadata !872, metadata !"out", metadata !874, i32 4, metadata !877} ; [ DW_TAG_arg_variable ]
!881 = metadata !{i32 5, i32 0, metadata !882, null}
!882 = metadata !{i32 458763, metadata !872, i32 4, i32 0} ; [ DW_TAG_lexical_block ]
!883 = metadata !{i32 6, i32 0, metadata !882, null}
!884 = metadata !{i32 7, i32 0, metadata !882, null}
!885 = metadata !{i32 11, i32 0, metadata !882, null}
!886 = metadata !{i32 15, i32 0, metadata !882, null}
!887 = metadata !{i32 459009, metadata !888, metadata !"in", metadata !2, i32 7, metadata !891} ; [ DW_TAG_arg_variable ]
!888 = metadata !{i32 458798, i32 0, metadata !1, metadata !"gaussian_1line", metadata !"gaussian_1line", metadata !"_Z14gaussian_1linePA1920_tS0_", metadata !2, i32 7, metadata !889, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!891 = metadata !{i32 458767, metadata !1, metadata !"", metadata !1, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !892} ; [ DW_TAG_pointer_type ]
!892 = metadata !{i32 458753, metadata !1, metadata !"", metadata !1, i32 0, i64 30720, i64 16, i64 0, i32 0, metadata !893, metadata !9, i32 0, null} ; [ DW_TAG_array_type ]
!893 = metadata !{i32 458788, metadata !1, metadata !"short unsigned int", metadata !1, i32 0, i64 16, i64 16, i64 0, i32 0, i32 7} ; [ DW_TAG_base_type ]
!894 = metadata !{i32 459009, metadata !888, metadata !"out", metadata !2, i32 7, metadata !891} ; [ DW_TAG_arg_variable ]
!895 = metadata !{i32 8, i32 0, metadata !896, null}
!896 = metadata !{i32 458763, metadata !897, i32 7, i32 0} ; [ DW_TAG_lexical_block ]
!897 = metadata !{i32 458763, metadata !888, i32 7, i32 0} ; [ DW_TAG_lexical_block ]
!898 = metadata !{i32 21, i32 0, metadata !896, null}
!899 = metadata !{i32 22, i32 0, metadata !896, null}
!900 = metadata !{i32 23, i32 0, metadata !896, null}
!901 = metadata !{i32 24, i32 0, metadata !896, null}
!902 = metadata !{i32 25, i32 0, metadata !896, null}
!903 = metadata !{i32 26, i32 0, metadata !896, null}
!904 = metadata !{i32 459008, metadata !896, metadata !"j", metadata !2, i32 20, metadata !905} ; [ DW_TAG_auto_variable ]
!905 = metadata !{i32 458788, metadata !1, metadata !"int", metadata !1, i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!906 = metadata !{i32 459008, metadata !896, metadata !"i", metadata !2, i32 20, metadata !905} ; [ DW_TAG_auto_variable ]
!907 = metadata !{i32 30, i32 0, metadata !896, null}
