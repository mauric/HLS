...
#ifndef _gaussian_sep_tmp_H_
#define _gaussian_sep_tmp_H_
...
struct gaussian_sep_tmp_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(gaussian_sep_tmp_core);
    gaussian_sep_tmp_core(sc_core::sc_module_name) {
...
SC_MODULE( gaussian_sep_tmp )
{
    ...
    SC_CTOR( gaussian_sep_tmp ) {
        meminst = new gaussian_sep_tmp_core <2, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    gaussian_sep_tmp_core <2, 1, DataWidth, AddressWidth, AddressRange>* meminst;
