...
void gaussian_sep_tmp::proc_mem_q()
{
...
void gaussian_sep_tmp::proc_mem_ra()
{
...
void gaussian_sep_tmp::proc_mem_ce()
{
    sc_lv<2> tmp;
    tmp[1] = ce0.read();
    tmp[0] = ce1.read();
...
void gaussian_sep_tmp::proc_mem_wa()
{
...
void gaussian_sep_tmp::proc_mem_we()
{
    sc_lv<1> tmp;
    tmp[0] = we0.read();
    mem_we.write(tmp);
...
void gaussian_sep_tmp::proc_mem_d()
{
...
void gaussian_sep_tmp::proc_addr()
{
...
// check collision
void gaussian_sep_tmp::proc_check()
{
    int f = 0;
    for (int i = 0; i < 1; i++) {
        for (int j = i + 1; j < 2; j++) {
